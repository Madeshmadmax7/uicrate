...
function Navbar() {
    ...
    return (
        <nav className="navbar">
            <div className="navbar-left" onClick={() => navigate(`/`)}>UI CRATE</div>
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="github-link">
                <svg height="32" viewBox="0 0 16 16" version="1.1" width="32" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#FFFFFF" d="M8 0C3.58 0 0 3.58 0 8a8 8 0 005.47 7.59c.4.07.55-.17.55-.38
                        ...
                        0 0 .67-.21 2.2.82a7.5 7.5 0 012.01-.27c.68 0 1.36.09 2.01.27
